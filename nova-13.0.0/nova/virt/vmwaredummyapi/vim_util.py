...
vmware_opts = cfg.IntOpt('maximum_objects', default=100,
                         help='The maximum number of ObjectContent data '
                              ...
                              'additional requests.')
CONF = cfg.CONF
CONF.register_opt(vmware_opts, 'vmwaredummy')
...
def get_object_properties(vim, collector, mobj, type, properties):
    ...
    options.maxObjects = CONF.vmwaredummy.maximum_objects
...
def get_objects(vim, type, properties_to_collect=None, all=False):
    ...
    return vutil.get_objects(vim, type, CONF.vmwaredummy.maximum_objects,
