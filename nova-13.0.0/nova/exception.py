...
class InstanceBackupCreateFailed(NovaException):
    msg_fmt = _("Backup instance %(instance_uuid)s,backup %(backup_uuid) failed.")

class InstanceBackupDeleteFailed(NovaException):
    msg_fmt = _("Backup Delete instance %(instance_uuid)s failed.")

class InstanceBackupNotFound(NotFound):
    msg_fmt = _("Instance %(backup_id)s could not be found.")

class NoValidHost(Invalid):
    msg_fmt = _("Not able to acquire a valid host.")
    
class NoValidNovaServer(Invalid):
    msg_fmt = _("Not able to acquire a valid server of nova-compute for vmware.")
